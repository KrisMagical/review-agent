"""FastAPI entry point for the MagicReview GitHub App."""
...
app = FastAPI(title="MagicReview GitHub App")
...
def main() -> None:
    ...
    uvicorn.run("magicreview.integrations.github.app:app", host=config.host, port=config.port)
